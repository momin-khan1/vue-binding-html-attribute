...
const image = [
  ...
  {
    image:
      "//images.unsplash.com/photo-1532274402911-5a369e4c4bb5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
  ...
  <section class="container mx-auto p-10">
    ...
    <section class="main flex space-x-4">
      <div class="flex space-y-4 flex-col w-1/3">
        <img :title="image[0].title" :src="image[0].image" alt="" />
      ...
      <div class="flex space-y-4 flex-col w-1/3">
        <img :title="image[1].title" :src="image[1].image" alt="" />
        <h2 class="text-xl text-left">{{ image[1].title }}</h2>
        <a
          target="_blank"
          :href="image[1].link"
          class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded w-40 text-center"
      ...
      <div class="flex space-y-4 flex-col w-1/3">
        <img :title="image[2].title" :src="image[2].image" alt="" />
        <h2 class="text-xl text-left">{{ image[2].title }}</h2>
        <a
          target="_blank"
          :href="image[2].link"
          class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded w-40 text-center"
